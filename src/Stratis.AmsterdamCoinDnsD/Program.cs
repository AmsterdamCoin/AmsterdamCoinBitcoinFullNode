...
namespace Stratis.AmsterdamCoinDnsD
{
    /// <summary>
    /// Main entry point.
    /// </summary>
    ...
    {
        private const string Agent = "AmsterdamCoinNode";
        ...
        public static async Task Main(string[] args)
        {
            try
            {
                var nodeSettings = new NodeSettings(networksSelector:Networks.AmsterdamCoin, protocolVersion:ProtocolVersion.PROTOCOL_VERSION, agent: Agent, args:args)
                {
