...
{
    public class AmsterdamCoinTest : Network
    {
       /// <summary> The name of the root folder containing the different AmsterdamCoin blockchains (AmsterdamCoinMain, AmsterdamCoinTest, AmsterdamCoinRegTest). </summary>
        ...
        public AmsterdamCoinTest()
        {
            ...
            this.Name = "AmsterdamCoinTest";
            this.NetworkType = NetworkType.Testnet;
            this.Magic = magic;
            this.DefaultPort = 50009;
            this.DefaultMaxOutboundConnections = 16;
            this.DefaultMaxInboundConnections = 109;
            this.DefaultRPCPort = 51009;
            this.DefaultAPIPort = 63009;
            ...
            this.CoinTicker = "TAMS";
            
            var consensusFactory = new PosConsensusFactory();

            // Create the genesis block.
            this.GenesisTime = 0;
            this.GenesisNonce = 489233;
            ...
            this.Consensus = new Consensus(
                ...
                coinbaseMaturity: 50,
                premineHeight: 1,
                premineReward: Money.Coins(10000),
            ...
            this.Base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { (20) };
            ...
            {
                new DNSSeedData("testnet1.amsterdamcoin.network", "testnet1.amsterdamcoin.network"),
                new DNSSeedData("testnet2.amsterdamcoin.network", "testnet2.amsterdamcoin.network")
            };
        ...
        {
            const string pszTimestamp = "https://testnet.amsterdamcoin.com/";
